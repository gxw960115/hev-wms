...
/**
 * <p>
 * Description: [基础数据手工生成条码表的domain类]
 * </p>
 ...
 * @version 1.0
 */
public class MdBarcode implements Serializable{

	/** 
	* @Fields serialVersionUID : (用一句话描述这个变量表示什么) 
	*/ 
	private static final long serialVersionUID = 4981526130556533594L;
	/** 主键 */
	private Long rowId;
	/** 物料号 */
