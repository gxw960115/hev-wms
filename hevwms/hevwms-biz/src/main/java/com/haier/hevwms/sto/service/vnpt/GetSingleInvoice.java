 ...
 *         &lt;element name="isReSync" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetSingleInvoice")
public class GetSingleInvoice {
    ...
    /**
     * Gets the value of the isReSync property.
     * 
     */
    public int getIsReSync() {
        return isReSync;
    }

    /**
     * Sets the value of the isReSync property.
     * 
     */
    public void setIsReSync(int value) {
        this.isReSync = value;
    }
