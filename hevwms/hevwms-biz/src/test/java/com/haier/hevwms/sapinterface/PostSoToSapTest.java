...
public class PostSoToSapTest {

    private String[] i = {"1111"};
    private PostSoToSap clientImplMock = null;
    ...
    public void init(){
        ...
        clientImplMock = new PostSoToSap(i,operationLogDAOMock,odsSoGrInfoDAOMock);
    }
    ...
    public void exchangeWithSap() {
        ...
        odsSoGrInfo.setBatchNo("1111111111111");
        list.add(odsSoGrInfo);
