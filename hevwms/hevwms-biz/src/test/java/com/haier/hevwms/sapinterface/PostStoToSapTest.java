...
public class PostStoToSapTest {

    private PostStoToSap clientImplMock = null;
    private OperationLogDAO operationLogDAOMock;
    private OdsStoGigrInfoDAO odsStoGigrInfoDAOMock;
    private OdsStoScanInfoDAO odsStoScanInfoDAOMock;
    ...
    public void init(){
        ...
        odsStoScanInfoDAOMock = EasyMock.createMock(OdsStoScanInfoDAO.class);
        clientImplMock = new PostStoToSap(i,operationLogDAOMock,odsStoGigrInfoDAOMock,odsStoScanInfoDAOMock);
    }
    ...
    public void exchangeWithSap() {
        ...
        odsStoScanInfoDAOMock.updateStodnInfo((OdsStoScanInfoDTO)EasyMock.anyObject());
        EasyMock.expectLastCall().times(2);
        EasyMock.replay(odsStoGigrInfoDAOMock);
        EasyMock.replay(odsStoScanInfoDAOMock);
