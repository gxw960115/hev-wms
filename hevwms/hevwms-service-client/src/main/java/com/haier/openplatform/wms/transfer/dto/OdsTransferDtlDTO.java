...
/**  
 * @Title:  OdsTransferDtlDTO.java   
 * @Description:TODO(用一句话描述该文件做什么)   
 * @author: zhangll
 * @date:   2018年11月7日 下午5:20:55   
 * @version V1.0 
 */  
public class OdsTransferDtlDTO implements Serializable {
    ...
    private String giBin;
    private String grBin;
	...
	public String getGiBin() {
		return giBin;
	}
	public void setGiBin(String giBin) {
		this.giBin = giBin;
	}
	public String getGrBin() {
		return grBin;
	}
	public void setGrBin(String grBin) {
		this.grBin = grBin;
	}
