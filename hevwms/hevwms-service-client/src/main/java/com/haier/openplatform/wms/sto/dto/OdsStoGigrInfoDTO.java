...
public class OdsStoGigrInfoDTO implements Serializable {
    /**
	 *
	 */
	private static final long serialVersionUID = -6886090143559690078L;
    ...
    private String vnptNo;

    public String getVnptNo() {
        return vnptNo;
    }

    public void setVnptNo(String vnptNo) {
        this.vnptNo = vnptNo;
    }
    ...
    public void setStodnNo(String stodnNo) {
        this.stodnNo = stodnNo == null ? null : stodnNo.trim();
    }
    ...
    public void setStodnItemNo(String stodnItemNo) {
        this.stodnItemNo = stodnItemNo == null ? null : stodnItemNo.trim();
    }
