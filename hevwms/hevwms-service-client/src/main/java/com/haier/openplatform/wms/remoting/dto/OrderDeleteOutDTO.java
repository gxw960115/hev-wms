 ...
 * @className: WmsOrderDeleteOutDTO.java
 * @description: 
 *
 * @version: v1.0.0
 * @author: LiuJiazhen
 * @date 2018年11月6日 下午3:51:03
 *
...
public class OrderDeleteOutDTO implements Serializable {

	private static final long serialVersionUID = 8850757524497322949L;
	...
	/**
	 * @Fields scanqty : (po订单物料累计扫描数量)
	 */
	private String scanqty;
	/**
	 * @Fields orderqty : (po订单物料需求数量)
	 */
	...
	public String toString() {
		return "OrderDeleteOutDTO [status=" + status + ", msg=" + msg + ", location=" + location + ", matno=" + matno
				+ ", matdesc=" + matdesc + ", scanqty=" + scanqty + ", orderqty=" + orderqty + "]";
	}
