 ...
 * @Description:
 */
public class ExportOdsStoScanInfoListTempletTest {
    ...
    public void buildBody() {
        ...
        List<OdsStoScanInfoDTO> list = new ArrayList<OdsStoScanInfoDTO>();
        OdsStoScanInfoDTO dto = new OdsStoScanInfoDTO();
        dto.setMaterialNo("111");
        list.add(dto);
        ExportOdsStoScanInfoListTemplet export = new ExportOdsStoScanInfoListTemplet(list);
        try {
