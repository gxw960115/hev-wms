 ...
 * @Description:
 */
public class ExportPsiReportTemplateTest {
    ...
    public void buildBody() {
        ...
        List<PsiReportDTO> list = new ArrayList<PsiReportDTO>();
        PsiReportDTO dto = new PsiReportDTO();
        dto.setMaterialNo("111");
        list.add(dto);
        ExportPsiReportTemplate export = new ExportPsiReportTemplate(list);
        try {
