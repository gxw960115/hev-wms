 ...
 * @Description:
 */
public class ExportStoIntransitReportTemplateTest {
    ...
    public void buildBody() {
        ...
        List<StoIntransitReportDTO> list = new ArrayList<StoIntransitReportDTO>();
        StoIntransitReportDTO dto = new StoIntransitReportDTO();
        dto.setMaterialNo("111");
        list.add(dto);
        ExportStoIntransitReportTemplate export = new ExportStoIntransitReportTemplate(list);
        try {
