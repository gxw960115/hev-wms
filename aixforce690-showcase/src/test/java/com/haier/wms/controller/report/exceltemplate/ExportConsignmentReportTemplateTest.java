 ...
 * @Description:
 */
public class ExportConsignmentReportTemplateTest {
    ...
    public void buildBody() {
        ...
        List<ConsignmentReportDTO> list = new ArrayList<ConsignmentReportDTO>();
        ConsignmentReportDTO dto = new ConsignmentReportDTO();
        dto.setMaterialNo("111");
        list.add(dto);
        ExportConsignmentReportTemplate export = new ExportConsignmentReportTemplate(list);
        try {
