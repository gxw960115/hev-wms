 ...
 * @className: ConsumePDAController.java
 * @description: 
 *
 * @version: v1.0.0
 * @author: LiuJiazhen
 * @date 2018年11月12日 上午9:50:51
 *
...
@Controller
public class ConsumePDAController {

	@Resource
	private ConsumePDAServiceClient consumePDAServiceClient;

	public void setConsumePDAServiceClient(ConsumePDAServiceClient consumePDAServiceClient) {
		this.consumePDAServiceClient = consumePDAServiceClient;
	}

	private static final Logger logger = Logger.getLogger(ConsumePDAController.class);
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/orderCheck", method = RequestMethod.POST, 
	...
	public String orderCheck(String username, String sign, String orderNo,
	    ...
	    logger.debug("Entering ConsumePDA_OrderCheck with user: " + username + ", sign: " + sign 
		...
		OrderCheckOutDTO orderResult = consumePDAServiceClient.consumeOrderCheck(inpara,version);
		
		String result = JsonMapper.JSON_NON_DEFAULT_MAPPER.toJson(orderResult);
		logger.debug("Exit ConsumeOrderCheck with result: " + result);
		return result;
	}

	/**
	 * @title: orderDownload
	 * @description: Consume订单，调用SAP进行下载
	 * @author: LJZ
	 * @version: v1.0.0
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/orderDownload", method = RequestMethod.POST,
		    produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	public String orderDownload(String username,String sign,String orderNo,
		...
		OrderLoadOutDTO outResult = consumePDAServiceClient.consumeOrderDownload(inpara, version);
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/orderDelelte", method = RequestMethod.POST,produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	public String orderDelete(String username,String sign,String orderNo,String barcode,String orderType,String version){
		...
		try {
			outResult = consumePDAServiceClient.consumeOrderDelete(inpara,version);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return JsonMapper.JSON_NON_DEFAULT_MAPPER.toJson(outResult);
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/ordersDelete", method = RequestMethod.POST,produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/orderIOgp", method = RequestMethod.POST,produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	public String poOrderIOgp(String orderNo,String sapFlag,OrderIgpInDTO inpara) {
		orderNo = this.orderNoFormat(orderNo);
		...
		try {
			outResult = consumePDAServiceClient.consumeOrderIgp(inpara, inpara.getVersion(),sapFlag);
		...
		logger.debug("Exiting ConsumePDAorderIOgp with result: " + result);
		return result;
	}
	 ...
	 * @throws  
	 */
	@RequestMapping(value = "/pdaConsume/orderPosting", method = RequestMethod.POST,produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	public String orderPosting(String orderNo,OrderIgpInDTO inpara,String sapFlag){
		...
		try {
			outResult = consumePDAServiceClient.orderPosting(inpara, sapFlag);
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		} catch (InvocationTargetException e) {
			e.printStackTrace();
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/barcodeList", method = RequestMethod.POST,
			produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	public String barcodeList(String username,String sign,String orderNo,String docType,String orderType) {
		...
		WmsOrderDelListOutDTO outResult = consumePDAServiceClient.barcodeList(inpara);
		return JsonMapper.JSON_NON_DEFAULT_MAPPER.toJson(outResult);
	}
	 ...
	 * @return: String
	 */
	@RequestMapping(value = "/pdaConsume/orderScan", method = RequestMethod.POST, produces = MediaType.TEXT_HTML_VALUE)
	@ResponseBody
	public String orderScan(String username,String sign,String orderNo,String barcode,String doctype,String orderType,
		...
		orderNo = this.orderNoFormat(orderNo);
		logger.debug("Entering ConsumeOrderScan with user: " + username + ", sign: "
		...
		OrderUploadOutDTO outResult = consumePDAServiceClient.consumeOrderScan(inpara,version);
		return JsonMapper.JSON_NON_DEFAULT_MAPPER.toJson(outResult);
	}
