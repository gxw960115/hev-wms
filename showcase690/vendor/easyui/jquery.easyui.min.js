...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,50,100,200],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_a7,_a8){
...
_24f.shadow=$("<div class=\"window-shadow\"><iframe frameborder= \"0\" scrolling=\"no\" style=\"background-color:transparent; position: absolute; z-index: -1; width: 100%; height: 100%; top: 0; left:0;\"></iframe></div>").insertAfter(_24f.window);
...
win.window({title:_280,noheader:(_280?false:true),width:300,left:document.documentElement.offsetWidth/2-125,top:document.documentElement.offsetTop+200,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
var _291="<div class=\"messager-progress\"><div class=\"messager-p-msg\"></div><div class=\"messager-p-bar\"> <iframe frameborder= \"0\" scrolling=\"no\" style=\"background-color:transparent; position: absolute; z-index: -1; width: 100%; height: 100%; top: 0; left:0;\"></iframe></div></div>";
