...
//				top: offset.top+input.offsetHeight,//悬浮框在下方
				left: offset.left
			}).show();
            if(options.scroll) {
                list.scrollTop(0);
                ...
                if((typeof document.body.style.maxHeight === "undefined")|| 
                    ...
                    list.css('height', scrollbarsVisible ? options.scrollHeight : listHeight );
	                 if(listHeight>190){//listHeight为无滚动条时的数据高度
	                	 element.css("top",offset.top-options.scrollHeight);
	                 }else{//输入条件时，listHeight为数据高度
	                	 element.css("top",offset.top-listHeight);
	                 }
