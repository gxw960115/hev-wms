...
(function(a) {
    ...
    p = function(a, b, c) {
        ...
        for (var j = 0; g > j; j++) {
            var k, l, m, n;
            i ? (k = c, f.push(h(a))) : (k = d[j].match(/@media *([^\{]+)\{([\S\s]+?)$/) && RegExp.$1, f.push(RegExp.$2 && h(RegExp.$2))),
            m = k.split(","),
            n = m.length;
    ...
    u = function(a) {
        ...
        n = l[l.length - 1],
        o = (new Date).getTime();
        if (a && q && i > o - q) return clearTimeout(r),
        r = setTimeout(u, i),
        void 0;
        q = o;
        ...
        for (var C in m) if (m.hasOwnProperty(C)) {
            ...
            D.styleSheet ? D.styleSheet.cssText = E: D.appendChild(c.createTextNode(E)),
            g.push(D)
        }
    },
    v = function(a, b) {
